...
pizzas = {"Small Hand Tossed Memphis BBQ Chicken":"P10IRECK",
...
def placeOrder(myOrder):
    ...
    data = order.data
    print(data)
    print(data["EstimatedWaitMinutes"])
    #data = order.place(card)
foodOrder = parseHololensOrder("Medium Hand Tossed Cheese Pizza,20 ounce sprite,20 ounce coke")
